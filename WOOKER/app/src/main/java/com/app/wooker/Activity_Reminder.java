    ...
    private void setupView() {
        ...
        btn_openapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Activity_Reminder.this.startActivity(intent);
                Activity_Reminder.this.finish();
            }
        });
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            FirebaseFirestore.getInstance().collection("jobs")
                    .whereEqualTo("wid", FirebaseAuth.getInstance().getUid())
                    ...
                    .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            if (queryDocumentSnapshots.isEmpty()) {
                                ...
                                if (i != 0) {
                                    if (i == 1) {
                                        tv_check_job.setText("You have a job today");

                                    } else {

                                        tv_check_job.setText("You have " + queryDocumentSnapshots.size() + " jobs today");
                                    }
                                }
                            }
                        }
